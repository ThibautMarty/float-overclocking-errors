...
TEST(ToolTests, Unpack)
{
  ap_uint<16> packed;

  UNPACK(packed, 1, 2) = ap_uint<8>(0xDE);
  UNPACK(packed, 0, 2) = ap_uint<8>(0xAD);

  EXPECT_EQ(packed, ap_uint<16>(0xDEAD));
  EXPECT_EQ(UNPACK(packed, 1, 2), ap_uint<8>(0xDE));
  EXPECT_EQ(UNPACK(packed, 0, 2), ap_uint<8>(0xAD));


  UNPACK(packed, 7, 8) = ap_uint<2>(0x3);
  UNPACK(packed, 6, 8) = ap_uint<2>(0x1);
  UNPACK(packed, 5, 8) = ap_uint<2>(0x3);
  UNPACK(packed, 4, 8) = ap_uint<2>(0x2);
  UNPACK(packed, 3, 8) = ap_uint<2>(0x2);
  UNPACK(packed, 2, 8) = ap_uint<2>(0x2);
  UNPACK(packed, 1, 8) = ap_uint<2>(0x3);
  UNPACK(packed, 0, 8) = ap_uint<2>(0x1);

  EXPECT_EQ(packed, ap_uint<16>(0xDEAD));
  EXPECT_EQ(UNPACK(packed, 7, 8), ap_uint<2>(0x3));
  EXPECT_EQ(UNPACK(packed, 6, 8), ap_uint<2>(0x1));
  EXPECT_EQ(UNPACK(packed, 5, 8), ap_uint<2>(0x3));
  EXPECT_EQ(UNPACK(packed, 4, 8), ap_uint<2>(0x2));
  EXPECT_EQ(UNPACK(packed, 3, 8), ap_uint<2>(0x2));
  EXPECT_EQ(UNPACK(packed, 2, 8), ap_uint<2>(0x2));
  EXPECT_EQ(UNPACK(packed, 1, 8), ap_uint<2>(0x3));
  EXPECT_EQ(UNPACK(packed, 0, 8), ap_uint<2>(0x1));
}
